...
const ReelsPage = ({navigation, route}) => {
  const videoRef = useRef(null);

  const {reelsDetail} = route.params;
  console.log(reelsDetail);
    ...
    <>
      ...
      <View
        ...
        <LinearGradient
          ...
          style={{flex: 1, height}}>
          <Video
            source={{uri: reelsDetail.reelAddressUrl}} // Can be a URL or a local file.
            ref={videoRef}
            onBuffer={onBuffer}
            resizeMode="cover"
          ...
          <View
            ...
            <View style={{flexDirection: 'row', alignItems: 'center'}}>
              <Image
                source={{uri: reelsDetail.user.profilePic}}
            ...
            <View style={{paddingVertical: 5, flexDirection: 'row'}}>
              <Text numberOfLines={1}>descriptions</Text>
              <Pressable>
                <Text>...more</Text>
              </Pressable>
            </View>
